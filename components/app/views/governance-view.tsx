  ...
  return (
    <div style={{ animation: "fadeUp 0.3s ease" }}>
      ...
      <div className="flex flex-col gap-3">
        {proposals.map((pr) => {
          const voted = votes[pr.id];
          const canVote = pr.status === "Active" && !voted;
          return (
            <div
              key={pr.id}
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="max-w-[520px] text-[15px] font-semibold">
                  {pr.title}
                </div>
                <div
              ...
              <div className="mt-3.5 flex h-2 gap-1 overflow-hidden rounded-md">
                <div
                  ...
                  style={{ width: `${pr.forPct}%` }}
                />
                <div
                  className="bg-negative"
                  style={{ width: `${pr.againstPct}%` }}
                />
              </div>
