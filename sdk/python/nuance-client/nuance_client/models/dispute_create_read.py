...
T = TypeVar("T", bound="DisputeCreateRead")



@_attrs_define
class DisputeCreateRead:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dispute_create_read.additional_properties = d
        return dispute_create_read
