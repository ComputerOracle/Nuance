...
T = TypeVar("T", bound="DisputeEnforceRequest")



@_attrs_define
class DisputeEnforceRequest:
    """ 
        Attributes:
            approved (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dispute_enforce_request = cls(
            approved=approved,
            ruling=ruling,
        )


        dispute_enforce_request.additional_properties = d
        return dispute_enforce_request
