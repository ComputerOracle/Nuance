...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> HealthHealthGetResponseHealthHealthGet | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[HealthHealthGetResponseHealthHealthGet]:
    return Response(
